    ...
    protected Class<?> findClass(final String className) throws ClassNotFoundException {
        if (setup.shouldAcquire(className)) {
          ...
          if (classBytesStream == null) throw new ClassNotFoundException(className);
            ...
            try {
                byte[] bytes;
                if (setup.shouldInstrument(new AsmClassDesc(className, classNode))) {
...
//                }
    ...
    public static class AsmClassDesc implements ClassDesc {
      private final String className;
      private ClassNode classNode;

        public AsmClassDesc(String className, ClassNode classNode) {
